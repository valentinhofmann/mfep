...
def main():
    ...
    # Load data
    df = pd.read_pickle('../../data/final/data_12_months.p')
    ...
    with open('results/scores_12_months_delta_a.txt', 'w') as f:
    ...
    # Write results to text files
    with open('results/scores_12_months_delta_r.txt', 'w') as f:
        f.write(' '.join(['{:3.3f}'.format(score) for score in scores]))
        f.write(' {:3.3f} $\\pm$ {:3.3f} '.format(np.mean(scores), np.std(scores)))

    # Load data
    df = pd.read_pickle('../../data/final/data_24_months.p')
    ...
    # Write results to text files
    with open('results/scores_24_months_delta_a.txt', 'w') as f:
        f.write(' '.join(['{:3.3f}'.format(score) for score in scores]))
        f.write(' {:3.3f} $\\pm$ {:3.3f} '.format(np.mean(scores), np.std(scores)))
    ...
    # Write results to text files
    with open('results/scores_24_months_delta_r.txt', 'w') as f:
        f.write(' '.join(['{:3.3f}'.format(score) for score in scores]))
        f.write(' {:3.3f} $\\pm$ {:3.3f} '.format(np.mean(scores), np.std(scores)))
